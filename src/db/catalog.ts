...
const TOKEN_BY_PRODUCT: [RegExp, DishToken][] = [
  [/куриц|курин|индейк|бедро|голень/i, 'chicken'],
  [/говядин|свинин|фарш говяж|котлет|бекон|ветчин|сосиск|колбас|печень/i, 'meat'],
  [/лосос|сёмг|треск|минтай|хек|тунец|креветк|скумбри|сельд|икра|краб/i, 'fish'],
  [/яйцо|яичн/i, 'egg'],
